function(tesseract_python_module PY_MOD_NAME )
  ...
  if (${PYTHON_VERSION_MAJOR} LESS 3)
    set_property(SOURCE ${PY_MOD_SWIG_SRC1} PROPERTY SWIG_FLAGS -relativeimport -threads)
  else()
    set_property(SOURCE ${PY_MOD_SWIG_SRC1} PROPERTY SWIG_FLAGS -relativeimport -threads -py3)
  endif()
  set_property(SOURCE ${PY_MOD_SWIG_SRC1} PROPERTY USE_LIBRARY_INCLUDE_DIRECTORIES TRUE)

  set(CMAKE_SWIG_OUTDIR ${CMAKE_CURRENT_BINARY_DIR}/python/${PY_MOD_PACKAGE})
  set(SWIG_OUTFILE_DIR ${CMAKE_CURRENT_BINARY_DIR})

  swig_add_module(${PY_MOD_NAME} python ${PY_MOD_SWIG_SRCS})
  swig_link_libraries(${PY_MOD_NAME} ${PY_MOD_LIBS} jsoncpp_lib
    yaml-cpp ${EIGEN3_LIBRARIES} ${PYTHON_LIBRARIES})
  ...
  set_target_properties(${PY_MOD_REAL_NAME}
    PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/python/${PY_MOD_PACKAGE})
  set_target_properties(${PY_MOD_REAL_NAME}
    PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELEASE ${CMAKE_CURRENT_BINARY_DIR}/python/${PY_MOD_PACKAGE})
  set_target_properties(${PY_MOD_REAL_NAME}
    PROPERTIES LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO ${CMAKE_CURRENT_BINARY_DIR}/python/${PY_MOD_PACKAGE})

  configure_file(${CMAKE_CURRENT_SOURCE_DIR}/cmake/__init__.py.in ${CMAKE_CURRENT_BINARY_DIR}/python/${PY_MOD_PACKAGE}/__init__.py @ONLY)
