...
%shared_ptr(tesseract::ContinuousContactManagerBase)

namespace tesseract
{
	
%nodefaultctor ContinuousContactManagerBase;
...
public:
	...
	virtual std::shared_ptr<ContinuousContactManagerBase> clone() const;
